...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen p-4 sm:p-8">
      ...
      <div className="w-full max-w-5xl p-6 bg-white rounded-xl shadow-xl ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700 mb-8">
        <form className="w-full" onSubmit={generateImage}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              <div className="mb-6">
                <label htmlFor="prompt" className="block text-gray-800 text-lg font-bold mb-2 dark:text-gray-200">
                  Prompt
                </label>
                <textarea
                  id="prompt"
                  ...
                  className="w-full h-32 p-4 text-gray-800 bg-gray-100 rounded-lg border-2 border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600"
                ...
                <div className="flex justify-between items-center mt-2">
                  ...
                  <div className="flex items-center">
                    <label htmlFor="enhance-toggle" className="text-sm text-gray-600 mr-2 dark:text-gray-400">
                      Enhance
                    </label>
                    <input
                      type="checkbox"
              ...
              <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <h2 className="text-gray-800 text-sm font-bold mb-4 dark:text-gray-200">BASIC SETTINGS</h2>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label htmlFor="model" className="block text-gray-600 text-xs mb-1 dark:text-gray-400">Model:</label>
                    <select
                      id="model"
                      value={model}
                      onChange={(e) => setModel(e.target.value)}
                      className="w-full py-2 px-3 text-gray-700 bg-white border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600"
                    >
                      {AI_MODELS.map(m => (
                  ...
                  <div>
                    <label htmlFor="seed" className="block text-gray-600 text-xs mb-1 dark:text-gray-400">Seed:</label>
                    <div className="flex items-center">
                      <input
                        id="seed"
                        type="number"
                      ...
                      <button
                        ...
                        className="ml-2 bg-gray-200 hover:bg-gray-300 text-gray-700 py-2 px-3 rounded-md transition-colors dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-gray-200"
            ...
            <div>
              <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <h2 className="text-gray-800 text-sm font-bold mb-4 dark:text-gray-200">ADVANCE SETTINGS</h2>
              ...
              <div className="p-4 bg-gray-50 rounded-lg border border-gray-200 dark:bg-gray-700 dark:border-gray-600">
                <h2 className="text-gray-800 text-sm font-bold mb-4 dark:text-gray-200">FORMAT SETTINGS</h2>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 mt-8">
            <button
              type="submit"
              className={`flex-1 py-3 px-6 rounded-lg font-bold text-lg text-white transition-all duration-300 ${loading ? 'bg-gray-400 cursor-not-allowed' : 'bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700'}`}
              disabled={loading}
            >
            ...
            <button
              ...
              className="flex-1 py-3 px-6 rounded-lg font-bold text-sm bg-gray-200 hover:bg-gray-300 text-gray-800 transition-all duration-300 dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500"
            >
              Generate JSON
            </button>
          </div>
      ...
      {jsonConfig && (
        <div className="mt-8 w-full max-w-5xl p-6 bg-white rounded-xl shadow-xl ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">JSON Configuration</h2>
          <pre className="text-sm bg-gray-100 rounded-lg p-4 overflow-x-auto whitespace-pre-wrap break-words text-gray-800 dark:bg-gray-700 dark:text-gray-300">
      ...
      {image && !loading && (
        <div className="mt-8 w-full max-w-5xl p-6 bg-white rounded-xl shadow-xl ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700 flex flex-col items-center">
          <h2 className="text-xl font-semibold mb-4 text-gray-800 dark:text-gray-200">Generated Image</h2>
          <img 
            src={image} 
          ...
          <button
            ...
            className="py-2 px-4 rounded-lg font-semibold text-white bg-green-500 hover:bg-green-600 transition-colors duration-300"
          >
            Download PNG
          </button>
        </div>
      ...
      {history.length > 0 && (
        <div className="mt-12 w-full max-w-5xl p-6 bg-white rounded-xl shadow-xl ring-1 ring-gray-200 dark:bg-gray-800 dark:ring-gray-700">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-200">Prompt History</h2>
            <button
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
            {history.map((item, index) => (
              <div key={index} className="flex flex-col p-4 bg-gray-100 rounded-lg shadow-sm dark:bg-gray-700">
                <img
                  src={item.imageUrl}
                  alt="History"
                  className="w-full h-auto object-cover rounded-lg mb-2 border border-gray-200 dark:border-gray-600"
                />
                <p className="text-sm text-gray-700 line-clamp-2 dark:text-gray-300">{item.prompt}</p>
